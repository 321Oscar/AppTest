...
namespace AppTest.FormType
{
    public partial class GetForm : BaseDataForm
    {
        ...
        private void AddSignalToPanel(out int minHeight)
        {
            ...
            ///倒序添加
            for (int i = Signals.Signal.Count - 1; i > -1; i--)
            {
                ...
                if (!CurrentIDs.Contains(int.Parse(Signals.Signal[i].MessageID, System.Globalization.NumberStyles.HexNumber)))
                {
                    CurrentIDs.Add(int.Parse(Signals.Signal[i].MessageID, System.Globalization.NumberStyles.HexNumber));
                }
            }
