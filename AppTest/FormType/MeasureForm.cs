...
namespace AppTest.FormType
{
    public partial class MeasureForm : BaseDataForm
    {
        ...
        private int CurvePointMaxCount = 200;
        ...
        private readonly Color ScopeColor = Color.FromArgb(0, 170, 173);
        ...
        public MeasureForm():base()
        {
            ...
            //btn.BackColor = Color.FromArgb(0, 170, 173);
        ...
        protected override async void OnDataRecieveEvent(object sender, UsbCan.CANDataRecieveEventArgs args)
        {
        ...
        /// 添加曲线，Y轴
        /// </summary>
        private void AddLinetoPlotFromSignal()
        {
            plotModel.Series.Clear();
            ...
            {
                DBCSignal signal = Signals.Signal[i];
                Signals.Signal[i].StrValue = "0";
                //增加Y轴
                ...
                plotView1.Model.Axes.Add(new LinearAxis
                {
                    ...
                    StartPosition = i / (double)Signals.Signal.Count,
                    EndPosition = (i + 0.8) / (double)Signals.Signal.Count,
        ...
        private void GetDataByInterval(object interval)
        {
        ...
        /// </summary>
        /// <param name="sender"></param>
        private async void GetDataTimer_Elapsed(object sender)
        {
