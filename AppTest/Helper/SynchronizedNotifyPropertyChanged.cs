...
namespace AppTest.Helper
{
    ...
    where T : INotifyPropertyChanged
    {
        ...
        protected virtual void OnPropertyChanged(string propertyName)
        {
            ...
            //var res = _syncObject.BeginInvoke(handler, new object[] { this, new PropertyChangedEventArgs(propertyName) });
            //_syncObject.EndInvoke(res);
        }

        public void OnDataRecievedComplete(IAsyncResult asyncResult)
        {
            AsyncResult result = (AsyncResult)asyncResult;
            _syncObject.EndInvoke(asyncResult);
        }
