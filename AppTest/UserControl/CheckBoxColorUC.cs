...
namespace AppTest.FormType
{
    public partial class CheckBoxColorUC : UserControl
    {
        ...
        /// </summary>
        private Color color;
        private DBCSignal dBCSignal;
        private string signalName;
        public DBCSignal DBCSignal { get => dBCSignal;private set => dBCSignal = value; }
        /// <summary>
        /// 是否显示
        /// </summary>
        ...
        public CheckBoxColorUC(DBCSignal dBCSignal, Color color)
        {
            InitializeComponent();
            ...
            var threadSafeModel = new SynchronizedNotifyPropertyChanged<DBCSignal>(dBCSignal, this);
